...
title: Foodly
date: 06-20-2020
description: Online food ordering platform with role-based interfaces for customers, restaurants, and delivery riders. Built with PHP, MySQL, and AJAX for real-time order tracking.
...
info:
  - text: GitHub
    ...
    icon:
      ...
      name: github
  - text: Contributors
    link: https://github.com/namanvashistha/foodly/graphs/contributors
    icon:
      type: lucide
      name: users
---
