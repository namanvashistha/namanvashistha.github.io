...
description: Machine learning project using Self-Organizing Maps (Kohonen Neural
  Networks) to cluster and visualize crime data patterns on interactive maps.
date: 11-15-2018
image: ../assets/crime-knn.png
info:
  - text: GitHub
