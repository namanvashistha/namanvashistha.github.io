...
title: Hyperbole
date: 04-10-2019
description: A custom programming language and IDE built from scratch in C++. Features its own syntax, interpreter, and interactive development environment.
...
info:
  - text: GitHub
    ...
    icon:
      ...
      name: github
  - text: Documentation
    link: https://namanvashistha.github.io/hyperbole/
    icon:
      type: lucide
      name: book
---
