...
title: Chess
date: 03-15-2024
description: Real-time multiplayer chess application with bitboard engine, WebSocket support, and Redis caching. Play chess against others with a clean web interface.
