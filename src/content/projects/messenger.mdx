---
title: Messenger
description: Real-time web messenger built with PHP and AJAX. Features instant
  messaging, user authentication, and live message updates without page
  refreshes.
date: 08-25-2017
image: ../assets/messenger-new-photoroom-3-.png
info:
  - text: GitHub
