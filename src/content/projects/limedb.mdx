---
title: LimeDB
description: A highly-scalable distributed key-value store with peer-to-peer
  architecture, consistent hashing, and custom storage engine. Built to deeply
  understand distributed systems fundamentals.
date: 11-10-2025
image: ../assets/peer-to-peer-lime.png
info:
  - text: GitHub
