...
description: Join me on my journey building LimeDB - a distributed key-value
  store built from scratch to deeply understand distributed systems, database
  internals, and horizontal scaling.
